#ifndef APP_PERSON_CLUSTER_HPP_
#define APP_PERSON_CLUSTER_HPP_

#include <pcl/people/person_cluster.h>

template <typename PointT>
app::PersonCluster<PointT>::PersonCluster (
...
app::PersonCluster<PointT>::getIndices ()
{
  return (points_indices_);
}

template <typename PointT> float
app::PersonCluster<PointT>::getHeight ()
{
  return (height_);
}

template <typename PointT> float
app::PersonCluster<PointT>::updateHeight (const Eigen::VectorXf& ground_coeffs)
{
...
template <typename PointT> float
app::PersonCluster<PointT>::updateHeight (const Eigen::VectorXf& ground_coeffs, float sqrt_ground_coeffs)
{
...
template <typename PointT> float
app::PersonCluster<PointT>::getDistance ()
{
  return (distance_);
}

template <typename PointT> Eigen::Vector3f&
app::PersonCluster<PointT>::getTTop ()
{
  return (ttop_);
}

template <typename PointT> Eigen::Vector3f&
app::PersonCluster<PointT>::getTBottom ()
{
  return (tbottom_);
}

template <typename PointT> Eigen::Vector3f&
app::PersonCluster<PointT>::getTCenter ()
{
  return (tcenter_);
}

template <typename PointT> Eigen::Vector3f&
app::PersonCluster<PointT>::getTop ()
{
  return (top_);
}

template <typename PointT> Eigen::Vector3f&
app::PersonCluster<PointT>::getBottom ()
{
  return (bottom_);
}

template <typename PointT> Eigen::Vector3f&
app::PersonCluster<PointT>::getCenter ()
{
  return (center_);
}

template <typename PointT> Eigen::Vector3f&
app::PersonCluster<PointT>::getMin ()
{
  return (min_);
}

template <typename PointT> Eigen::Vector3f&
app::PersonCluster<PointT>::getMax ()
{
  return (max_);
}

template <typename PointT> float
app::PersonCluster<PointT>::getAngle ()
{
  return (angle_);
}

template <typename PointT>
float app::PersonCluster<PointT>::getAngleMax ()
{
  return (angle_max_);
}

template <typename PointT>
float app::PersonCluster<PointT>::getAngleMin ()
{
  return (angle_min_);
}

template <typename PointT>
int app::PersonCluster<PointT>::getNumberPoints ()
{
  return (n_);
}

template <typename PointT>
float app::PersonCluster<PointT>::getPersonConfidence ()
{
  return (person_confidence_);
}

template <typename PointT>
void app::PersonCluster<PointT>::setPersonConfidence (float confidence)
{
  person_confidence_ = confidence;
}

template <typename PointT>
void app::PersonCluster<PointT>::setHeight (float height)
{
  height_ = height;
}

template <typename PointT>
void app::PersonCluster<PointT>::drawTBoundingBox (pcl::visualization::PCLVisualizer& viewer, int person_number)
{
